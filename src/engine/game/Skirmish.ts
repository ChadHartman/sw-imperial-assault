namespace SwiaEngine.Game {
    ...
    export class Skirmish {
        ...
        public readonly deploymentZones: Array<SwiaEngine.Model.IDeploymentZone>;

        constructor(
            id: string,
            config: SwiaEngine.Model.ISkirmishConfig,
            tiles: Array<SwiaEngine.Model.ITile>) {
        ...
        private createTileTable(tiles: Array<SwiaEngine.Model.ITile>): [string, SwiaEngine.Model.ITile] {
            let table = <[string, SwiaEngine.Model.ITile]>{};
        ...
        private addSpaces(offsetX: number, offsetY: number, rotation: number, tile: SwiaEngine.Model.ITile) {
        ...
        private getMax(tile: SwiaEngine.Model.ITile, attribute: string) {
            var max = 0;
            for (let space of tile.spaces) {
